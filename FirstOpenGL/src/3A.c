...
int main(int argc, char **argv) {
	//glutInit is used to initialise the glut library
	glutInit(&argc, argv);
...
/// we chose very few points to show the vector field with enough spacing between the vectors
/// to make it clear and readable
/// </summary>
void plotDisplay() {
	//Two if conditions are written so as to show two different vector directions on the viewport
...
/// Therefore we draw each vector with only 40% of its length for better representation of the field
/// </summary>
/// <param name="X1">x coordinate of the base point of the vector</param>
/// <param name="Y1">y coordinate of the base point of the vector</param>
void vector(int X1, int Y1) {
	int x = X1, y = Y1;
	X2 = X1 + y;
	Y2 = Y1 - x;
